...
public class CartPage {
    ...
    By place_order_button=By.xpath("//a[contains(text(),'Place Order')]");
    By navigate_to_home_button=By.xpath("//a[contains(text(),'Home /')]");
    ...
    public void ClickNavigateHomeButton(){driver.findElement(navigate_to_home_button).sendKeys(Keys.RETURN);}
}
