...
public class LoginPage {
    ...
    By popupOkButton = By.xpath("//body/div[3]/div[4]/div[1]/div[3]/a[1]");
    ...
    public boolean InvalidCredentials() {
        return wait.until(ExpectedConditions.visibilityOfElementLocated(invalidCredintials)).isDisplayed();
    }

    public void ClickInvalidOk() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(popupOkButton)).isDisplayed();
